...
from sql_sparse_einsum import sql_einsum_query
...
def time_sqlite_query(query):
    ...
    print(
        f"sqlite result: {sql_res}\n(computed in {toc - tic - time_planning}s) - planning time: {time_planning}")


if __name__ == "__main__":
    QUERY_PATH = False
    SAT_952 = True
    sql_file = "SQL/sat_952_query.sql"
    ...
    if QUERY_PATH:
        ...
        if SAT_952:
            einsum_notation, arrays = create_sat_952()
        else:
